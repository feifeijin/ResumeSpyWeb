<template>
  <v-sheet id="team" class="text-center py-16" color="secondary" min-height="800">
    <div class="text-h4 font-weight-bold">Resume Templates</div>
    ...
    <v-container>
      <v-row>
        <v-col v-for="person in team" :key="person.name" class="pa-5" cols="12" md="4">
